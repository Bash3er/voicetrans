...
class VoiceTransApp:
    ...
    def _build_content(self, parent):
        ...
        self._log("system", "Install deps: pip install sounddevice argostranslate pyttsx3 numpy vosk edge-tts imageio-ffmpeg", "dim")
    ...
    def _start(self):
        ...
        self._status_lbl.config(text="loading VOSK model…")
